      ...
      <div className='aboutContainer'>
       ...
       <div className='aboutQuestions'>
            <p>
                ...
                <br />
                <br />
                Svenja Schweres und Niko Schweres, Podcast-Hosts, Ehepaar und Geschäftspartner, sind die kreativen Köpfe und Gründer von Grey Mountains Media und <em>brandit.</em> – dem Brandingpodcast. Svenja ist eine erfahrene Videoproduzentin, während Niko seit knapp 20 Jahren als Kameramann tätig ist. Die beiden kennen sich in und auswendig und ergänzen sich daher perfekt als Team.
                <br />
                <br />
                <strong>Die Vision hinter <em>brandit.</em></strong>
                <br />
                <br />
                Die Gründung von <em>brandit.</em> entstand aus dem Wunsch heraus, unser Wissen und unsere Erfahrungen im Bereich Branding mit anderen zu teilen. Unsere Vision ist es, gemeinsam unseren Zuhörern und Zuschauern zu helfen, ihre Branding-Ziele zu erreichen. Dabei geht es darum, Gatekeeping zu überwinden und mit allen Menschen, die Interesse am Thema Branding haben, das Wissen zu teilen, über das wir verfügen.
                <br />
                <br />
                <strong>Das Ziel von <em>brandit.</em></strong>
                <br />
                <br />
                Das Ziel von <em>brandit.</em> ist es, unseren Zuhörern und Zuschauern praktische Tipps & Tricks, kostengünstige Branding-Strategien, theoretisches Wissen über Branding sowie effektive Strategien zu vermitteln, um sich von der Masse abzuheben. <em>brandit.</em> - der Branding-Podcast dient als Infotainment und soll den Zuhörern einen Mehrwert bieten, indem er sie inspiriert, informiert und befähigt, ihre eigenen Branding-Ziele zu erreichen. Wir möchten unseren Hörern nicht nur theoretisches Wissen vermitteln, sondern auch konkrete Handlungsempfehlungen geben, die ihnen dabei helfen, ihre Marke erfolgreich zu gestalten.
                <br />
                <br />
                <strong>Welche Themen behandelt <em>brandit.</em>?</strong>
                <br />
                <br />
